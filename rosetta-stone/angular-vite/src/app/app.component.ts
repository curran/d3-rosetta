...
export class AppComponent implements AfterViewInit {
  ...
  private setStateWrapper = (updaterFn: (prevState: Record<string, any>) => Record<string, any>) => {
    ...
    this.ngZone.runOutsideAngular(() => {
      ...
      if (this.containerRef?.nativeElement) {
        main(this.containerRef.nativeElement, { state: this.state, setState: this.setStateWrapper });
      }
    });
