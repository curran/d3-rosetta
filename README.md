...
[D3](https://d3js.org/) rendering logic with unidirectional
data flow.
...
- [`createStateField`](#createstatefield) - Simplifies
  ...
  properties.
- [`unidirectionalDataFlow`](#unidirectionaldatalflow) -
...
environment. For a more detailed explanation of the pattern
itself, see
[The Solution: Unidirectional Data Flow](#the-solution-unidirectional-data-flow).
